...
export function FormExamples() {
  ...
  return (
    <div className="space-y-8 p-6">
      <h2 className="text-2xl font-heading text-white">Form Examples</h2>

      {/* Basic Form Fields */}
      <section>
        <h3 className="text-lg font-heading text-primary mb-4">Basic Form Fields</h3>
      ...
      <section>
        <h3 className="text-lg font-heading text-primary mb-4">Rating Tiles</h3>
        <div>
      ...
      {/* Form States */}
      <section>
        <h3 className="text-lg font-heading text-primary mb-4">Form States</h3>
        <div className="space-y-4 max-w-md">
          {/* Success State */}
          <div>
            <label className="block text-sm font-medium text-gray mb-1">
          ...
          <div>
            ...
            <input
              type="text"
              className="input-field border-red-500"
              value="Invalid input"
              readOnly
            />
      ...
      {/* Form Actions */}
      <section>
        <h3 className="text-lg font-heading text-primary mb-4">Form Actions</h3>
